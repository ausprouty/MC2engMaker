...
<ul class="forward">
	<li>Review the principles of Spiritual Breathing from lesson 3, &ldquo;<!-- begin linkInternal capacitor-->
<span id= "Return1" class="internal-link" @click="this.goToPageAndSetReturn('/M2/eng/multiply1/multiply103', '#1')">
    Keeping in Step with the Spirit 
</span>
<!-- end linkInternal capacitor-->
&rdquo;</li>
...
<p>For further enrichment: Read <em><!-- begin linkInternal capacitor-->
<span id= "Return2" class="internal-link" @click="this.goToPageAndSetReturn('/M2/eng/tc/tc04', '#2')">
