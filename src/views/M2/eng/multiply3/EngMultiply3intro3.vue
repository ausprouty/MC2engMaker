...
<div id="showVideoOptions"></div>
  <p>   
    ...
    <vue-image-zoomer
    regular="/images/zoom/sites/mc2/content/M2/eng/multiply3/Trip1.png" 
    zoom="/images/zoom/sites/mc2/content/M2/eng/multiply3/Trip1.png" :zoom-amount="3" img-class="img-fluid" alt="">
    <img src="@/assets/sites/mc2/content/M2/eng/multiply3/Trip1.png" img-class="img-fluid" />
    </vue-image-zoomer>
    </div></p>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Period 3: Expanding to New Territories: ', '/content/M2/eng/multiply3/multiply3intro3.html')">
